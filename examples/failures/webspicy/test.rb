...
webspicy_config(Path.dir) do |c|
  ...
  c.world.junitxml_output = StringIO.new
  c.colorize = false
  ...
  c.reporter << Webspicy::Tester::Reporter::JunitXmlFile.new(c.world.junitxml_output)
  c.reporter << Tester::Reporter::SuccessOrNot.new
end
